        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAttr,index in spuSaleAttrList" :key="spuSaleAttr.baseSaleAttrId">
            ...
            <div class="cartWrap">
              <div class="controls">
                ...
                <a class="mins" @click="changeSubtractNum">-</a>
              </div>
              <div class="add">
  ...
  methods: {
    ...
    async addShopCar() {
      try {
        ...
        // 实现跳转带参数,object参数最好要以sessionStorage存储,
        this.$router.push({
          name: "addCartSsccess",
          query: {
            skuNum: this.skuNum
        ...
        // 把数据存储到sessionStorage中，传送一些复杂的数据
