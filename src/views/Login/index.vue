            ...
            <form action="##">
              ...
              <div class="setting clearFix">
                <label class="checkbox inline">
                  <input name="m1" type="checkbox" value="2" ref="isChecked" />
                  自动登录
                </label>
...
export default {
  ...
  mounted() {
    ...
    this.password = this.$route.query.loginPassword || "";
  },
  methods: {
    async userLogin() {
      try {
        // 登录派发action,向服务器发请求获得请求头
        this.userName &&
          this.password &&
          (await this.$store.dispatch("user/userLogin", {
            phone: this.userName,
            password: this.password,
            isChecked: this.$refs.isChecked.checked,
          }));
        //登录之前判断是否有query参数如果有的话就跳转到query上没有跳转到home上
